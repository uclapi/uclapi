...
class Marketplace extends React.Component {
  constructor(props) {
    ...
    if (DEBUGGING) {
      console.log("All apps loaded in: " + allApps);
    }
  ...
  render() {
    ...
    const { featuredApps, appsToRender } = this.state;

    return (
      <>
        <Head>
          <title>Marketplace - UCL API</title>
        </Head>
        ...
        <Container styling="secondary" heading="Featured App">
          <Row width="1-1" maxWidth="1000px" horizontalAlignment="center">
        ...
        <Container styling="splash-parallax" heading="All Apps">
          <Row width="1-1" maxWidth="1000px" horizontalAlignment="center">
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <p className={styles.app}>{app.description}</p>
                  </Row>
                </CardView>
              );
            })}
