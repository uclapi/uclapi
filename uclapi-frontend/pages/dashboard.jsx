      ...
      <>
        ...
        >
          <CardView width="1-1" type="default" noPadding>
            ...
            <Button onClick={() => actions.acceptAup()}>I agree</Button>
            <Button
              color="red"
              appearance="primary"
        ...
        >
          {toDelete !== -1 ? (
            <ConfirmBox
              ...
              success={() => {
                actions.deleteProject(toDelete);
              }}
              fail={() => {
                this.setState({ view: "default" });
              }}
        ...
        >
          <Row width="1-1">
            <Column width="2-3" alignItems="column" style={{ margin: "auto" }}>
              <h1>Welcome, {name}</h1>
              <h3>username: {cn}</h3>
              ...
              <div className={`${styles.appHolder} app-holder`}>
                {apps.length === 0 ? (
                  <CardView width="1-1" type="default" noPadding>
                    <h2>
                      You haven&apos;t created any apps yet, click below to get
                      started!
                    </h2>
                  </CardView>
                ) : (
  ...
  deleteProject = async (index) => {
    ...
    try {
      ...
      this.setState({
        ...
        data: {
          ...data,
          apps: [...data.apps.slice(0, index), ...data.apps.slice(index + 1)],
        },
      });
    } catch (error) {
      window.alert(error.message);
