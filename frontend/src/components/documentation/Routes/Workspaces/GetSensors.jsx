...
const WorkspacesGetSensors = ({ activeLanguage }) => {
  return (
    <div>
      <Topic
      ...
      >
        ...
        <p>
          ...
          within every map in a survey/library.
          
          It can optionally provide the current state of a sensor
          (i.e. Occupied / Absent),
          but by default it will only list the sensors without their states.
        </p>
      ...
      >
        <h2>Response</h2>
        <p>
          This endpoint will return a list of every map within a survey,
          and within it every sensor associated with that map.
          
          It will optionally also return the latest triggered state of
          that sensor (e.g. whether the seat was marked triggered or occupied).
        </p>
        <p>
          Note that the following response data table is deliberately
          incomplete. This is because we return additional metadata
          that is not yet useful, and often left blank by the provider.
          
          We will update this documentation if and when these
          extra parameters become useful.
        </p>
        <Table
          name="Response"
        >
...
export default WorkspacesGetSensors
