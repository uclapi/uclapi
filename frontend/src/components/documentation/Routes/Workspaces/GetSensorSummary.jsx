...
const WorkspacesGetSensorsSummary = ({ activeLanguage }) => {
  return (
    <div>
      <Topic
      ...
      >
        ...
        <p>
          ...
          the number of seats within each library region that are
          free and occupied.
          
          It is best suited to integrations which show cumulative, live data.
          Developers can use this endpoint to avoid making many parallel or
        ...
        <p>
          ...
          which allows students to leave their seat
          unattended for up to thirty minutes at a time
          (e.g. to use the bathroom or get food).
          
          This means that the Summary endpoint may return a lower number
          of available seats when compared to reality if many students leave
          the library within a short period of time.
          
          The UCL Library&apos;s website and the UCL Go! mobile application
          both follow this rule, so your app or integration should have parity
          with first party data sources by using the UCL API.
        </p>
      ...
      >
        <h2>Response</h2>
        <p>
          This endpoint will return a list with every survey requested,
          and its associated maps.
          
          Within each map is a count of absent (i.e. vacant) and occupied seats.
          The endpoint also returns the total number of seats in each library
          that are absent or occupied.
        </p>
        <p>
          If your application or integration is designed to inform
          students of the total number of free seats in a library
          please ensure you use the survey total figures.
          
          This is because many sensors have not yet been assigned to
          maps on our data provider&apos;s system which means that relying
          only on map counts will leave many seats unaccounted for.
          
          We are actively working with our data provider to rectify this, and we
...
export default WorkspacesGetSensorsSummary