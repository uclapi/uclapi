...
const WorkspacesGetLiveImage = ({ activeLanguage }) => {
  return (
    <div>
      <Topic
      ...
      >
        ...
        <p>
          ...
          This circle is coloured based on whether the
          seat is occupied or absent (i.e. vacant).
        </p>
        <p>
          There are also several parameters that let you
          customise the map to suit your app or integration.
        </p>
      ...
      >
          ...
          <p>
            ...
            can be retrieved via <code>/workspaces/sensors</code>.
            
            An example of this returned data is on the right.
          </p>
      </Topic>
    </div>
  )
...
export default WorkspacesGetLiveImage