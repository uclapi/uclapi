...
const WorkspacesGetSurveys = ({ activeLanguage }) => {
  return (
    <div>
      <Topic
      ...
      >
        ...
        <p>
          ...
          Cad-Capture devices fitted to the seats.
          
          Each library is known as a &apos;survey&apos;,
          as it is a survey of the building.
          
          Within each survey there are multiple &apos;maps&apos;,
          each of which corresponds to a section such as a level,
          wing or separated library work area.
          
          Each sensor is tied to a specific map,
          and each map belongs to a survey.
        </p>
      ...
      >
        <h2>Response</h2>
        <p>
          The surveys key contains a list of dictionaries,
          each of which corresponds to a library survey with
          seating sensors attached.
          
          Each survey has a number of maps, corresponding to
          regions within the library, such as a different floor or wing.
        </p>
        <p>
          Note that the <code>location[address]</code> field will not
          always contain a precise address,
          and may simply contain the address to the UCL campus
...
export default WorkspacesGetSurveys