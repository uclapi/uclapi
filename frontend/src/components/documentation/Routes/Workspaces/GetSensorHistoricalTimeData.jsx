...
const WorkspacesGetSensorHistoricalTimeData = ({ activeLanguage }) => {
  return (
    <div>
      <Topic
      ...
      >
        ...
        <p>
          ...
          This can be used, for example, in apps and integrations
          which show users how busy each library is at given times of the day.
          
          You can show data based on the last day (e.g. yesterday),
          the last week or the last month.
          
          Each day&apos;s data is updated in the early hours of the morning
          (around 2am)
          so that users during the day have the latest data.
        </p>
      ...
      >
        ...
        <p>
          ...
          its ID, its name and average data for the period requested for
          every 10 minute period in a day.
          
          The averages are not ordered, so it is recommended that the data
          is fed into some other code to transform the data in such as way
          as to ensure that it is user-friendly.
          
          One example might be a graphing library to plot the data throughout
          the day to produce an average occupancy graph.
        </p>
        <p>
          Please note that the counts below may not perfectly add up.
          ...
          However, if you do get large, unexplained differences do let us
          know so that we can look into it.
        </p>
        <p>
          Please note further that there are some rare situations where
          the data source we use may have historical data missing.
          
          Sitautions that can cause this include new libraries being added which
          do not yet have historical data available, and
          situations where data has
          ...
          If time periods are missing your application should alert
          the user to data being missing and fail gracefully.
        </p>
...
export default WorkspacesGetSensorHistoricalTimeData