...
const GetTimetableByModules = ({ activeLanguage }) => {
  return (
    <div>
      <Topic
      ...
      >
        <h2>Response</h2>
        <p>
          This endpoint will create a timetable for the
          module ids provided and return the yearly calendar.
        </p>
        <p>
          The <code>timetable</code> field contains an
          object where dates are mapped to event objects.
        </p>
        <Table
          name="Response"
        >
...
export default GetTimetableByModules