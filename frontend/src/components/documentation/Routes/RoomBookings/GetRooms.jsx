...
r = requests.get("${Constants.DOMAIN}/roombookings/rooms", params=params)
print(r.json())`,

  shell: `curl -G ${Constants.DOMAIN}/roombookings/rooms \\
-d token=uclapi-5d58c3c4e6bf9c-c2910ad3b6e054-7ef60f44f1c14f-a05147bfd17fdb`,

  javascript: `fetch("${Constants.DOMAIN}/roombookings/rooms?token=uclapi-5d58c3c4e6bf9c-c2910ad3b6e054-7ef60f44f1c14f-a05147bfd17fdb")
.then((response) => {
  ...
  return (
    <div>
      ...
      >
        ...
        <p>
          Endpoint: <code>{Constants.DOMAIN}/roombookings/rooms</code>
        </p>
        <p>
