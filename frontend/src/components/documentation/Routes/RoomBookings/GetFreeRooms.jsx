...
const GetFreeRooms = ({ activeLanguage }) => {
  return (
    <div>
      <Topic
      ...
      >
        ...
        <p>
          ...
          this endpoint returns all rooms which are free in that time range.
        </p>
        <p>
          <i>
      ...
      >
        <h2>Response</h2>
        <p>
          The <code>free_rooms</code> field contains
          all rooms that are free in the given time range.
        </p>
        <Table
          name="Response"
        >
