...
r = requests.get("${Constants.DOMAIN}/dashboard/api/analytics/total/", params=params)
print(r.json())`,

  shell: `curl -G ${Constants.DOMAIN}/dashboard/api/analytics/total/ \
-d token=uclapi-5d58c3c4e6bf9c-c2910ad3b6e054-7ef60f44f1c14f-a05147bfd17fdb`,

  javascript: `fetch("${Constants.DOMAIN}/dashboard/api/analytics/total/?token=
    ...
    return (
      <div>
        ...
        >
          ...
          <p>
            Endpoint:&nbsp;
            <code>{Constants.DOMAIN}/dashboard/api/analytics/total</code>
          </p>
